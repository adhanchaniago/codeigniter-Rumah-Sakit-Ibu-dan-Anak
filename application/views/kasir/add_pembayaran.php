          ...
          <div class="box box-primary" >
            ...
            <form style="" role="form" method="post" action="<?php echo base_url('page/simpanpembayaran') ?>" enctype="multipart/form-data" >
              ...
              <div class="box-body">
                ...
                <input type="text" class="form-control" id="jenis_pemeriksaan" name="jenis_pemeriksaan" value="">
                </div>
                </div>
                ...
                <input type="text" class="form-control" id="nilai_normal" name="nilai_normal" value="">
                </div>
                 </div>
