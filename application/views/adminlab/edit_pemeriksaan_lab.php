...
<html>
  <head>
    <title>Edit Pemeriksaan Lab</title>
    ...
    <?php echo date('l, d  M  Y'); ?></td>
        ...
        <div  class=" container ">
          ...
          <div class="box box-primary" >
            ...
            <form style="" role="form" method="post" action="<?php echo base_url('page/simpanpemeriksaan_lab') ?>" enctype="multipart/form-data" >
              ...
              <div class="box-body">
               ...
               <!--  <div class="col-md-10">
                ...
                <label for="jenis_pemeriksaan">Id</label>
                 <input type="text" name="id_pasien" value="<?php if(isset($pembayaran)) echo $pembayaran->id_pasien; ?>">
</div>
                </div> -->
