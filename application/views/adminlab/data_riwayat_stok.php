...
<html>
  ...
  <body>
    ...
    <?php echo date('l, d  M  Y'); ?></td>
        ...
        <div  class=" container ">
          <center><h4>Riwayat Logistik Laboraturium</h4></center>
          <div style=" padding-left: 150px " class="col-md-10 text-right" style=" padding-bottom: 3px; ">
            <a class="btn btn-default" href="<?php echo base_url(); ?>page/add_stok"><i class="glyphicon glyphicon-plus "></i> Tambah Stok</a> </div>
            <div style=" padding-left: 150px " class="col-md-10">
            ...
            <tbody>
               <?php $no=1; foreach ($stok as $lg){  ?>
                    <tr>
                        ...
                        <td><?php echo $lg->jml_penyetokan; ?></td>
                      <!--   <td><?php echo $lg->satuan; ?></td> -->
                      
                        <!-- <td style=" text-align: center; "> 
                           <a class="btn btn-info glyphicon glyphicon-edit" href="edit_logistik/<?php echo $lg->id_nilai; ?> "> </a>
