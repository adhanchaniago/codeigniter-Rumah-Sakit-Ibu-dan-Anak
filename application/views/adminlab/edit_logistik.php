...
<html>
  <head>
    <title>Edit atau Tambah Pasien</title>
          ...
          <div class="box box-primary" >
            ...
            <form style="" role="form" method="post" action="<?php echo base_url('page/simpanlogistik') ?>" enctype="multipart/form-data" >
              ...
              <div class="box-body">
                ...
                <input type="text" class="form-control" id="nama_brg" name="nama_brg" value="<?php if(isset($editlog)) echo $editlog->nama_brg ?>">
                </div>
                </div>
                ...
                <input type="date" class="form-control" id="tglbeli" name="tglbeli" value="<?php if(isset($editlog)) echo $editlog->tglbeli ?>">
                </div>
                 </div>
                ...
                <input type="date" class="form-control" id="tglkadaluarsa" name="tglkadaluarsa" value="<?php if(isset($editlog)) echo $editlog->tglkadaluarsa ?>">
                </div>
                 </div>
                ...
                <input type="number" class="form-control" id="stok" name="stok" value="<?php if(isset($editlog)) echo $editlog->stok ?>">
                </div>
                </div>
