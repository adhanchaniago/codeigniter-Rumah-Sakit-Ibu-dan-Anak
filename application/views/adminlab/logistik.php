...
<html>
  <head>
    <title>Logistik Laboraturium</title>
            ...
            <tbody>
               <?php $no=1; foreach ($logistik as $lg){  ?>
                    <tr>
                        ...
                        <td><?php echo $lg->tglbeli; ?></td>
                        <td><?php echo $lg->tglkadaluarsa; ?></td>
                        <td><?php echo $lg->stok; ?></td>
                      
                        <!-- <td style=" text-align: center; "> 
                           <a class="btn btn-info glyphicon glyphicon-edit" href="edit_logistik/<?php echo $lg->id_nilai; ?> "> </a> --> 
                        <!-- <a class="btn btn-primary glyphicon glyphicon-plus" href="add_logistik/<?php echo  $lg->id_nilai; ?>"></a>
