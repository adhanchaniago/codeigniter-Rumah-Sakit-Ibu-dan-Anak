               ...
               <?php $no=1; foreach ($user as $u){  ?>
                    <tr>
                        ...
                        <td style=" text-align: center; "> 
                          <a target="_blank" class="btn btn-default" href="cetak_pasien/<?php echo @$u->id_pasien; ?> ">Cetak </a>
                           <a class="btn btn-warning" href="data_pasien/<?php echo $u->id_pasien; ?> ">Data </a> 
