...
<html>
  ...
  <body>
    ...
    <?php echo date('l, d  M  Y'); ?></td>
        ...
        <div  class=" container ">
          <center><h4>Data Pasien yang Harus Diproses</h4></center>
               ...
               <?php $no=1; foreach ($user as $u){  ?>
                    <tr>
                        ...
                        <td style=" text-align: center; ">  
                           <a class="btn btn-info" href="pemeriksaanlab/<?php echo $u->id_pasien; ?> ">Pemeriksaan Lab </a> 
                           <a class="btn btn-warning " href="diagnosa/<?php echo  $u->id_pasien; ?>">Diagnosa</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
